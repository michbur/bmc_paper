...
and analyze amplification curve data in a combined work-flow. The GUI embedding chipPCR
function are accessible as the web server service under the address: 
