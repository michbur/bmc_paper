...
\title{chipPCR: an R Package to Pre-Process Amplification Curve 
Data}
...
\address[id=aff2]{%
  \orgname{Department of Genomics, Faculty of Biotechnoloy, University of 
Wroc\l{}aw},
  \street{Fryderyka Joliot-Curie 14a},
  \postcode{50-383}
  \city{Wroc\l{}aw},
  \cny{Poland}
}
...
for statistical computing and graphics. We used Donald Knuth's literate 
programming principle to present the source code in the most convenient way for 
the users \cite{Knuth1984}. The package is available at CRAN 
...
several element violate this convention (e.g., functions names). 
...
\cite{RDCT2010c}. @MICHAL{Something about the chipPCR objects here} To spread 
