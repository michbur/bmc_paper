...
\section*{Figures}
  \begin{figure*}[h]
  \includegraphics[clip=true,trim=0cm 0cm 0cm 0cm,width=16cm]{problems}
...
fluorescence values are plotted against the cycle. The amplification curvecd  
has a sigmoidal shape 
(\textcolor{black}{\textendash},~\textcolor{red}{\textendash}). Amplification 
...
\begin{figure*}[h]
  \includegraphics[clip=true,trim=0cm 0cm 0cm 0cm,width=16cm]{browser}
  \caption{\label{figure:browser}
  \csentence{Locally running \emph{shiny} \textsl{AmpSim.gui} app.} 
\emph{(Top)} 
The plot of the \textsl{AmpSim.gui} is shown in a standard browser 
(\textbf{Iceweasel}, v. 29.0.1) along with the parameters (left panel). The 
code 
...
\begin{figure*}[h]
  \includegraphics[clip=true,trim=0cm 0cm 0cm 0cm,width=16cm]{smoother}
