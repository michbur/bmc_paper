...
It contains tools for the raw data exploration: normalization, baselining, 
imputation of missing values, smoothing amplification curves and detecting the start 
...
GUI's (web-based and standalone \emph{shiny} applications) streamlining analysis and report generation.
...
sophisticated statistical tools and allows reproducing analysis on different platforms as well as adopting to changing experimental setups. Moreover, it is 
...
dependent amplification (HDA)) (Suppl. Sect.~10). % Suppl. Sect.~\ref{sec:XX}
\end{methods}
