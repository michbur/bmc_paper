...
for quantification cycle estimation solely the $\emph{chipPCR}$ functions 
...
object with summary method \textsl{summary-der} for the $SDM$ (second derivative 
maximum). Thanks to the GUI it should be easy even for an users without any 
\textbf{R} experience omitting the biggest limitation of all \textbf{R} packages 
